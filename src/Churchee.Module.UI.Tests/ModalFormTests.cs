...
namespace Churchee.Module.UI.Tests
{
    public class ModalFormTests : BasePageTests
    {
        ...
        public void CancelButton_Invokes_OnCancelForm()
        {
            ...
            var cancelled = false;
            var onCancel = EventCallback.Factory.Create(this, (Action)(() => cancelled = true));

            // Act
            var cut = RenderComponent<ModalForm>(parameters => parameters
        ...
        public void Submit_ValidModel_Invokes_OnSave()
        {
            ...
            var model = new TestModel { Name = "abc" };
            var saved = false;
            var onSave = EventCallback.Factory.Create<object>(this, (Action<object>)(_ => saved = true));
        ...
        public async Task OnSaveException_IsCaught_And_LoggedAsError()
        {
            ...
            // OnSave that throws
            var onSave = EventCallback.Factory.Create<object>(this, (Func<object, Task>)(async _ =>
            {
                await Task.Yield();
            ...
            mockLogger.Verify(
                x => x.Log(
                    LogLevel.Error,
                    It.IsAny<EventId>(),
                    It.Is<It.IsAnyType>((v, t) => v.ToString().Contains("Error Submitting form")),
                    It.IsAny<Exception>(),
