...
{
    internal class PageTypesPagingSpecification : Specification<PageType>
    {
        public PageTypesPagingSpecification(string searchText, int take, int skip, string orderByField, string orderDir)
        {
